...
public class TestData {
	...
	List<Book> allBooks = new ArrayList<Book>() {
		{
			add(new Book("111", "The Big Fish", 21, Arrays.asList(allAuthors.get(0), allAuthors.get(1))));
			...
			add(new Book("333", "Jimmy's First Day of School", 7, Arrays.asList(allAuthors.get(4))));
